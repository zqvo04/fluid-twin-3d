...
export function pumpSkidNetwork(): PipelineNetwork {
  return {
    ...
    nodes: [
      // Suction side
      { id: 'SUCTION_TANK', type: 'reservoir', position: { x: -8, y: 2, z: 0 }, fixedHead: 2 },
      { id: 'PUMP_IN', type: 'junction', position: { x: -3, y: 1, z: 0 }, demand: 0 },
      // Pump skid internal
      { id: 'PUMP_OUT', type: 'junction', position: { x: 0, y: 1, z: 0 }, demand: 0 },
      { id: 'SKID_HDR', type: 'junction', position: { x: 3, y: 1, z: 0 }, demand: 0 },
      // Delivery
      { id: 'RISER_TOP', type: 'junction', position: { x: 20, y: 25, z: 0 }, demand: 0 },
      { id: 'ELEVATED_TANK', type: 'reservoir', position: { x: 28, y: 30, z: 0 }, fixedHead: 30 },
    ],
    links: [
